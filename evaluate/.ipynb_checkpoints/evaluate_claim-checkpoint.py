...
if __name__=="__main__":
    ...
    for i in ori_data:
        ...
        if str(qid) in pred_data.keys() and len(i["predicted_evidence"])>=1 :
            ...
            re_lst.append({"id":qid,"claim":claim,"predicted_label":label_mapping[2],
                "label":label,"predicted_evidence":i["predicted_evidence"],"evidence":evidence_set,"predicted_pages":pred_pages})
