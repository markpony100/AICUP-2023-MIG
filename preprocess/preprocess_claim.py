            ...
            for evids in evidence_pair:
                ...
                for evi_id, evi_idx in evidss:
                    ...
                    if with_pageID:
                        ...
                        joined_evidence.append(evi_value)
                evidence_list = "[SEP]".join(joined_evidence[:5])
...
if __name__ == "__main__":
    ...
    TRAIN_SAVE_PATH = "../pert_large/claim_data/train_cluster_folds.json"
    TEST_PATH = "../pert_large/sent/0522_base_clu_folds_PN13/all_test.jsonl"
    TEST_SAVE_PATH = "../pert_large/claim_data/all_test.json"
    #wiki mapping
    ...
    for i,fold_idx in enumerate(kfold_idx):
        ...
        train= join_with_evidence(pd.DataFrame(train_data),mapping,mode="train",topk=5,with_pageID=False)
        val= join_with_evidence(pd.DataFrame(val_data),mapping,mode="train",topk=5,with_pageID=False)
    ...
    test = join_with_evidence(pd.DataFrame(TEST_DATA),mapping,mode="test",with_pageID=False)
